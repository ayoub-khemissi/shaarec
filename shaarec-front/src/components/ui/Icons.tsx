...
function Icon({ className = "size-5", strokeWidth = 2, children }: IconProps & { children: React.ReactNode }) {
  return (
...
function FilledIcon({ className = "size-5", children }: { className?: string; children: React.ReactNode }) {
  return (
...
export function GlobeIcon(props: IconProps) {
  return (
    <Icon {...props} strokeWidth={props.strokeWidth ?? 1.5}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9 9 0 100-18 9 9 0 000 18zM3.6 9h16.8M3.6 15h16.8M12 3c2.5 2.7 3.9 6.2 3.9 9s-1.4 6.3-3.9 9c-2.5-2.7-3.9-6.2-3.9-9s1.4-6.3 3.9-9z" />
    </Icon>
  );
}
